  ...
  var loadMyCartEvent = function(userOptions){
    ...
    if(!$("#" + idCartModal).length) {
      $('body').append(
        ...
        '<a href="checkout.php"><button type="button" class="btn btn-primary ' + classCheckoutCart + '">Checkout</button></a>' +
        '</div>' +
        '</div>' +
        '</div>' +
        '</div>'
    ...
    var drawTable = function(){
      ...
      $.each(products, function(){
        ...
        $cartTable.append(
          ...
          '<td title="Quantity"><input type="number" min="1" style="width: 80px;" class="' + classProductQuantity + '" value="' + this.quantity + '"/></td>' +
