 ...
 <body class="sticky-header left-side-collapsed"  onload="initMap()">
    ...
    <!-- left side start-->
		<div class="left-side sticky-left-side">
			...
			<div class="logo">
				<h1><a href="index.html">Deallo <span>Admin</span></a></h1>
			</div>
							...
							<li class="dropdown profile_details_drop">
								<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
									<div class="profile_img">	
										<span style="background:url(images/peanut.png) no-repeat center"> </span> 
										 <div class="user-name">
											<p>Vivien<span>Administrator</span></p>
										 </div>
        ...
        <!--footer section start-->
			<footer>
			   <p>&copy Deallo Craft House. All Rights Reserved 2017 <!-- Design by <a href="https://w3layouts.com/" target="_blank">w3layouts. --></a></p>
			</footer>
        <!--footer section end-->
