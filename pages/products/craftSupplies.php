...
<head>
	...
	<title>Deallo Product - Craft Supplies</title>
...
<div class="container">
	...
	<div class="row">
        <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12 coverImage">
            <img src="../../images/cover-art/craftCover.jpg" alt="Craft Supplies art cover art" height="100%" class="img-responsive" width="100%"/>
        </div>
    </div>
	<hr/>
