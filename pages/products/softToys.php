...
<head>
	...
	<title>Deallo Product - Soft Toys </title>
...
<div class="container">
	...
	<div class="row">
        <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12 coverImage">
            <img src="../../images/cover-art/toysCover.jpg" alt="toys cover art" height="100%" class="img-responsive" width="100%"/>
        </div>
    </div>
	<hr/>
	...
	<div class="row">
		...
		<div class="list-group col-lg-3 col-md-3 col-sm-5 col-xs-6">
			...
			<a href="#" class="list-group-item">Soft Toys</a>
